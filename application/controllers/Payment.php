...
class Payment extends MY_Controller {
	...
	public function get()
    {
        $fetch_data = $this->main->make_datatables('paymentModel');
        $sr = $_POST['start'] + 1;
        $data = array();
        ...
        $output = array(  
            ...
            "recordsFiltered"   => $this->main->get_filtered_data('paymentModel'),
            "data"              => $data,
            $csrf_name          => $csrf_hash
        );
	...
	public function view($id)
	{
		...
		$data['operation'] = "view";
        $data['url'] = $this->redirect;
		$data['data'] = $this->main->get($this->table, 'payment', ['id' => d_id($id)]);
