...
class Address extends MY_Controller {
    ...
    private $title = 'delivery address';
    private $table = "address";
    private $redirect = "address";
	...
	public function get()
    {
        $fetch_data = $this->main->make_datatables('addressModel');
        $sr = $_POST['start'] + 1;
        $data = array();
	...
	public function view($id)
	{
		...
		$data['operation'] = "view";
        $data['url'] = $this->redirect;
		$data['data'] = $this->main->get($this->table, 'address', ['id' => d_id($id)]);
