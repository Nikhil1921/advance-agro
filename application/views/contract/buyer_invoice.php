<div class="invoice overflow-auto">
	<div style="min-width: 600px">
			...
			<table style="margin-bottom: 10px;">
				<tbody>
					...
					<tr>
						...
						<td> : </td>
						<td colspan="2"><strong>0.00 % OF BILL VALUE</strong></td>
					</tr>
					<tr>
						<td colspan="4"><hr></td>
					</tr>
		...
		<!-- <footer>
            <strong style="color: #96bc5f">OFFICE</strong> - 
				E-324, NEW MARKET YARD, UNJHA - 384170 
				<strong style="color: #96bc5f">MOBILE</strong> : +91 98250 52356, +91 73595 31459 
				<?= nbs(45) ?>
				<strong style="color: #96bc5f">
				E-Mail</strong> : advanceagribrokers @gmail.com
        </footer> -->
	</div>
</div>